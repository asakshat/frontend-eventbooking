...
const images = [
  ...
  // 'https://eadn-wc01-4383690.nxedge.io/wp-content/uploads/2023/11/5433200373_9b6d2c2257_o-scaled.jpg',
  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="flex flex-col justify-center w-3/5 p-10">
        <h1 className="text-8xl font-bold">Event Booking</h1>
        <p className="text-2xl font-bold py-10">
          Discover exciting opportunities and stay connected with the latest happenings.
        </p>
      ...
      <div className="w-2/5 h-screen relative">
        {images.map((image, index) => (
          <div
            ...
            style={{ backgroundImage: `url(${image})`, backgroundSize: 'cover', backgroundPosition: 'center', zIndex: index === currentImageIndex ? 10 : 1 }}
          />
        ))}
      </div>
    </div>
