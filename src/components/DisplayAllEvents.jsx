	...
	return (
		<div className="min-h-screen p-10">
			<div className="flex flex-col">
				<h1 className="text-3xl  text-center md:text-3xl font-bold m-2 p-4">
					Events
				</h1>
			</div>
			<div className="flex flex-wrap gap-9">
				{!events
					...
					: events.events.map((event) => (
							<div
								key={event.ID}
								className="w-64 bg-white rounded-lg shadow-lg p-6 h-96 flex flex-col justify-between border hover:scale-110 transition-transform duration-300 ease-in-out"
							>
