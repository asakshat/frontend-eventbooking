...
function CreateEvent() {
  ...
  return (
    <div className="flex flex-col items-center p-10 min-h-screen">
      <form className="grid grid-cols-1 md:grid-cols-2 gap-4 p-5 bg-white text-black shadow-lg rounded-lg w-full max-w-5l" onSubmit={handleSubmit}>
        <h1 className="col-span-1 md:col-span-2 text-3xl font-bold mb-4 text-lefy">Create Event</h1>
        ...
        <button className="btn btn-primary col-span-1 md:col-span-2 mt-4 w-full" type="submit">
          Submit
        </button>
        {responseMessage && (
          <p className="mt-2 col-span-1 md:col-span-2 text-center text-red-500">{responseMessage}</p>
        )}
      </form>
